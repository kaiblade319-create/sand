  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 sm:mb-12">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-1.5 p-1.5 rounded-2xl bg-[#e3e2e0]/60 backdrop-blur-sm self-start lg:self-auto overflow-x-auto max-w-full">
              <button
                className={`px-4 py-2 rounded-xl font-label-caps text-[11px] sm:text-xs tracking-[0.12em] uppercase transition-all whitespace-nowrap cursor-pointer ${
                  activeFilter === 'all'
                ...
                type="button"
              >
                All Rooms ({ACCOMMODATIONS.length})
              </button>
              <button
                className={`px-4 py-2 rounded-xl font-label-caps text-[11px] sm:text-xs tracking-[0.12em] uppercase transition-all whitespace-nowrap cursor-pointer ${
                  activeFilter === 'garden'
              ...
              <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-5 mt-5 border-t border-[#e3e2e0]/40 grid grid-cols-2 gap-2.5">
                  ...
                  <button
                    ...
                    type="button"
                    className="w-full py-2.5 rounded-xl bg-[#0f1c2e] text-white font-label-caps text-[11px] sm:text-xs uppercase tracking-[0.14em] hover:bg-[#346364] transition-all duration-300 shadow-sm font-medium flex items-center justify-center gap-1 cursor-pointer"
                  >
        ...
        <div className="mt-12 sm:mt-16 bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-[#e3e2e0]/40 shadow-sm">
